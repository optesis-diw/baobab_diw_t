...
class AccountAssetDepreciationLine(models.Model):
    ...
    tag_ids = fields.Many2many(comodel_name='account.analytic.tags', string='account Tags', deprecated=True, help='tag')
    all_tag_ids = fields.Many2many(comodel_name='account.axis.tag', string=' Axis tags1', help='This contains the axis tags for this depreciation line.')
