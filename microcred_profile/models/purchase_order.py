...
class PurchaseOrder(models.Model):
    ...
    company_amount_untaxed = fields.Monetary(string='Untaxed Amount Company Currency', store=False, readonly=True, compute='_amount_company_all', tracking=True, currency_field='company_currency_id')
    company_amount_tax = fields.Monetary(string='Taxes Company Currency', store=False, readonly=True, compute='_amount_company_all', currency_field='company_currency_id')
    company_amount_total = fields.Monetary(string='Total Company Currency', store=False, readonly=True, compute='_amount_company_all', currency_field='company_currency_id')
