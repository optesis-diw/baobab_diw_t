...
class BudgetLineType(models.Model):
    ...
    tag_ids = fields.Many2many(comodel_name='account.analytic.tag',tracking=True, string=' Axis tags11 for the budget element', help='This contains the axis tags for this budget element.')
    all_tag_ids = fields.Many2many(comodel_name='account.axis.tag', string=' Axis tags12',tracking=True, help='This contains the axis tags for this purchase line.')
    ...
    sequence = fields.Integer(string=' Sequence budget', help='The sequence of the line types.', default=100)
    full_sequence = fields.Integer(string='full Sequence', help='The sequence of the line types.', store=True, compute='_compute_full_sequence')
