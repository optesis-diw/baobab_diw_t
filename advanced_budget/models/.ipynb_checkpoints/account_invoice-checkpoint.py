...
class AccountInvoice(models.Model):
    ...
    distribution_cost_ids = fields.One2many('budget.element.distribution', 'move_id', string='Cost distribution')
    default_budget_element_id = fields.Many2one('budget.element', string='Default Budget element')  # Used to pre-fill budget element
    ...
    def copy(self, default=None):
        ...
        for line in new_id.invoice_line_ids:
            if line.budget_element_id.state != ('open'):
                line.budget_element_id = True
            else:
                line.budget_element_id = True
