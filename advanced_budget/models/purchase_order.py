...
class PurchaseOrder(models.Model):
    ...
    distribution_cost_ids = fields.One2many('budget.element.distribution', 'purchase_id', string='Cost distribution')
    ...
    def copy(self, default=None):
        ...
        for line in new_id.order_line:
            if line.budget_element_id and line.budget_element_id.state != 'open':
