...
class WizardModifyAmountDetails(models.TransientModel):
    ...
    amount = fields.Float(string='New amount', digits_compute="Account", help='Enter the new amount.')
...
class WizardModifyAmount(models.TransientModel):
    ...
    amount = fields.Float(string='New amount', digits_compute="Account", help='Enter the new amount.')
    max_amount = fields.Float(string='Max amount', digits_compute="Account", help='The maximum amount.')
